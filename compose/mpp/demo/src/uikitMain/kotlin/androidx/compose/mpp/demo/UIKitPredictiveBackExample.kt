...
import androidx.compose.ui.backhandler.UIKitPredictiveBackHandler
...
val UIKitPredictiveBackExample = Screen.Example("UIKitPredictiveBackExample") {
    UIKitPredictiveBackExampleContent()
}

@OptIn(ExperimentalComposeUiApi::class)
@Composable
private fun UIKitPredictiveBackExampleContent() {
    ...
    Column(
            ...
            Dialog(
                ...
                Card {
                    Box(modifier = Modifier.background(MaterialTheme.colors.surface).padding(16.dp)) {
                        ...
                        Text("state: $bhState")
                        UIKitPredictiveBackHandler { events ->
                            try {
        ...
        UIKitPredictiveBackHandler(enablePredictiveBackHandler) { events ->
            try {
                events.collect { event ->
